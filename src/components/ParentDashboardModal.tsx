...
import { X, ShieldCheck, Users, BarChart3, MessageSquare, BookOpen, Clock, ChevronRight, ArrowLeft, Lock } from 'lucide-react';
          ...
          <div className="p-8 text-center max-w-md mx-auto space-y-4">
            ...
            <form onSubmit={handleVerifyParentPin} className="space-y-3">
              <input
                ...
                className="w-full text-center tracking-[0.3em] font-mono text-xl py-2.5 px-4 rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 focus:outline-none focus:border-amber-500"
              />
                ...
                <div className="space-y-5">
                  ...
                  <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 text-xs sm:text-sm text-slate-600 dark:text-slate-300 space-y-2">
                    <h4 className="font-bold text-slate-800 dark:text-slate-100 flex items-center gap-1.5">
                      💡 Monitoraggio trasparente dei compiti
                    </h4>
                    <p className="leading-relaxed">
                      Socrate salva automaticamente ogni sessione nel tuo database Firebase sicuro. Clicca sulla scheda{' '}
                      <strong>&quot;Rileggi le Chat dei Compiti&quot;</strong> per verificare le domande dei tuoi figli, 
                      come hanno risposto e quali materie hanno approfondito.
                    </p>
                  </div>
                </div>
              ) : (
